...
import calComRoutes from "./calComRoutes";
import notificamehubWebhookRoutes from "./notificamehubWebhookRoutes";
...
routes.use(notificamehubWebhookRoutes);
