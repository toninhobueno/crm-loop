  ...
  en: {
    translations: {
      ...
      login: {
        ...
        loginInstruction: "Sign in to access your account",
        form: {
          email: "Work email",
          password: "Your password",
          button: "Sign in to the platform",
          forgotPassword: "Forgot?",
        },
        marketing: {
          tagline: "Outbound & sales platform",
          trust: "Trusted by 2,500+ companies",
          headline: "Turn WhatsApp into a sales machine",
          subheadline:
            "Run campaigns, manage leads, and book meetings automatically. All in one dashboard.",
          b1: "Bulk sends",
          b2: "Multi-WhatsApp",
          b3: "Built-in CRM",
          b4: "Anti-blocking",
          testimonial:
            "We tripled our meetings in 30 days. The smart sending system is incredible.",
          author: "Carlos Mendes",
          role: "Sales Director",
          statLabel: "in meetings",
          statValue: "+180%",
        ...
        buttons: {
          ...
          forgotToast: "Password recovery coming soon. Contact support.",
          socialUnavailable: "Social sign-in coming soon.",
        },
      },
      adminLogin: {
        title: "Administrative backoffice",
        subtitle:
          "Master (super) accounts only. Open /admin/login — not linked from the app menu.",
        form: {
          email: "Email",
          password: "Password",
        },
        button: "Sign in to backoffice",
        deniedSuper:
          "Only master (super) users can access the backoffice.",
        linkRegular: "Sign in to the platform (operations)",
      },
      companies: {
      ...
      tagModal: {
        ...
        form: {
          ...
          nextLaneId: "Lane",
          laneKanbanPositionTitle: "Column position on Kanban",
          laneKanbanAnchor: "Reference column",
          laneKanbanPlacement: "Position relative to reference",
          laneKanbanPlacementBefore: "Before this column",
          laneKanbanPlacementAfter: "After this column",
          laneKanbanPlacementHelp:
            "Where this lane appears relative to another column (not yourself).",
        ...
        laneOrderApplyError:
          "Lane saved, but the column position could not be updated on the Kanban.",
      },
      fileModal: {
        title: {
          add: "Add File List",
      ...
      backendErrors: {
        ...
        ERR_NO_PERMISSION_WHATSAPP:
          "You don't have permission to access tickets from this connection.",
      ...
      whitelabel: {
        ...
        listItemBgColor: "Active Menu Background Color",
