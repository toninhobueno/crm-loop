  ...
  es: {
    translations: {
      ...
      login: {
        ...
        loginInstruction: "Entra para acceder a tu cuenta",
        form: {
          email: "Correo electrónico",
        ...
        marketing: {
          tagline: "Plataforma de prospección",
          trust: "Más de 2.500 empresas confían",
          headline: "Convierte WhatsApp en una máquina de ventas",
          subheadline:
            "Lanza campañas, gestiona leads y agenda reuniones automáticamente. Todo en un solo panel.",
          b1: "Envíos masivos",
          b2: "Multi-WhatsApp",
          b3: "CRM integrado",
          b4: "Anti-bloqueo",
          testimonial:
            "Triplicamos reuniones en 30 días. El envío inteligente es increíble.",
          author: "Carlos Mendes",
          role: "Director Comercial",
          statLabel: "en reuniones",
          statValue: "+180%",
        ...
        buttons: {
          ...
          registerHint: "¿No tienes cuenta?",
          rememberMe: "Mantenerme conectado",
          orContinue: "o continúa con",
          socialGoogle: "Google",
          socialFacebook: "Facebook",
          help: "¿Necesitas ayuda? Contáctanos",
          forgotToast: "Recuperación de contraseña pronto disponible.",
          socialUnavailable: "Inicio social disponible próximamente.",
        },
      },
      adminLogin: {
        title: "Backoffice administrativo",
        subtitle:
          "Solo cuentas master (super). Acceso por /admin/login — no aparece en el menú lateral.",
        form: {
          email: "Correo",
          password: "Contraseña",
        },
        button: "Entrar al backoffice",
        deniedSuper:
          "Solo el usuario maestro (super) puede acceder al backoffice.",
        linkRegular: "Entrar a la plataforma (operaciones)",
      },
      companies: {
      ...
      tagModal: {
        ...
        form: {
          name: "Nombre",
          color: "Color",
          laneKanbanPositionTitle: "Posición de la columna en Kanban",
          laneKanbanAnchor: "Columna de referencia",
          laneKanbanPlacement: "Posición respecto a la referencia",
          laneKanbanPlacementBefore: "Antes de esta columna",
          laneKanbanPlacementAfter: "Después de esta columna",
          laneKanbanPlacementHelp:
            "Define dónde aparece esta lane respecto a otra (excepto esta misma).",
        },
        buttons: {
          okAdd: "Agregar",
          okEdit: "Guardar",
        ...
        laneOrderApplyError:
          "Lane guardada, pero no se pudo actualizar la posición en el Kanban.",
      },
      fileModal: {
        title: {
      ...
      whitelabel: {
        ...
        listItemBgColor: "Color de Fondo del Menú Activo",
