  ...
  ar: {
    translations: {
      ...
      login: {
        ...
        loginInstruction: "سجّل الدخول للوصول إلى حسابك",
        form: {
          email: "البريد الإلكتروني",
          password: "كلمة المرور",
          button: "الدخول للمنصة",
          forgotPassword: "نسيت؟",
        },
        marketing: {
          tagline: "منصة للمبيعات",
          trust: "يثق بنا أكثر من 2,500 شركة",
          headline: "حوّل واتساب إلى آلة مبيعات",
          subheadline:
            "أطلق الحملات وأدر العملاء المتوقعين والاجتماعات تلقائياً. كل شيء في لوحة واحدة.",
          b1: "إرسال جماعي",
          b2: "عدة واتساب",
          b3: "CRM مدمج",
          b4: "ضد الحظر",
          testimonial:
            "ضاعفنا عدد الاجتماعات خلال 30 يوماً. النظام رائع.",
          author: "Carlos Mendes",
          role: "مدير المبيعات",
          statLabel: "في الاجتماعات",
          statValue: "+180%",
          usersLabel: "مستخدمون نشطون",
          usersCount: "+2,500",
          rating: "تقييم 4.9/5",
        },
        buttons: {
          submit: "الدخول للمنصة",
          register: "إنشاء حساب",
          registerHint: "لا تملك حساباً؟",
          rememberMe: "البقاء متصلاً",
          orContinue: "أو تابع باستخدام",
          socialGoogle: "Google",
          socialFacebook: "Facebook",
          help: "تحتاج مساعدة؟ تواصل معنا",
          forgotToast: "استعادة كلمة المرور قريباً.",
          socialUnavailable: "تسجيل الدخول الاجتماعي قريباً.",
        },
      },
      companies: {
        title: "تسجيل الشركة",
      ...
      tagModal: {
        ...
        form: {
          ...
          nextLaneId: "المسار",
          laneKanbanPositionTitle: "موضع العمود في لوحة كانبان",
          laneKanbanAnchor: "العمود المرجعي",
          laneKanbanPlacement: "الموقع بالنسبة للمرجع",
          laneKanbanPlacementBefore: "قبل هذا العمود",
          laneKanbanPlacementAfter: "بعد هذا العمود",
          laneKanbanPlacementHelp:
            "يحدد مكان ظهور هذا المسار بالنسبة لمسار آخر (وليس هذا المسار نفسه).",
        ...
        laneOrderApplyError:
          "تم حفظ المسار لكن لم يتم تحديث موضعه في لوحة كانبان.",
      },
      fileModal: {
        title: {
