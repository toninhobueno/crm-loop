  ...
  pt: {
    translations: {
      ...
      login: {
        ...
        loginInstruction: "Entre para acessar sua conta",
        form: {
        ...
        marketing: {
          tagline: "Plataforma de prospecção",
          trust: "Mais de 2.500 empresas confiam",
          headline: "Transforme seu WhatsApp em uma máquina de vendas",
          subheadline:
            "Dispare campanhas, gerencie leads e agende reuniões automaticamente. Tudo em um único painel.",
          b1: "Disparos em massa",
          b2: "Multi-WhatsApp",
          b3: "CRM integrado",
          b4: "Anti-bloqueio",
          testimonial:
            "Triplicamos nossas reuniões em 30 dias. O sistema de disparo inteligente é simplesmente incrível.",
          author: "Carlos Mendes",
          role: "Diretor Comercial",
          statLabel: "em reuniões",
          statValue: "+180%",
        ...
        buttons: {
          ...
          registerHint: "Não tem uma conta?",
          rememberMe: "Manter conectado",
          orContinue: "ou continue com",
          socialGoogle: "Google",
          socialFacebook: "Facebook",
          help: "Precisa de ajuda? Fale conosco",
          forgotToast: "Recuperação de senha em breve. Fale com o suporte.",
          socialUnavailable: "Login social disponível em breve.",
        },
      },
      adminLogin: {
        title: "Backoffice administrativo",
        subtitle:
          "Somente conta master (`super`). Acesso direto por /admin/login — não aparece no menu lateral.",
        form: {
          email: "E-mail",
          password: "Senha",
        },
        button: "Entrar no backoffice",
        deniedSuper:
          "Apenas usuário master (super) pode acessar o backoffice.",
        linkRegular: "Entrar na plataforma (atendimento)",
      },
      companies: {
      ...
      showTicketLogModal: {
        ...
        options: {
          ...
          pending: "devolveu ao departamento.",
      ...
      whatsappModal: {
        ...
        form: {
          ...
          queueRedirectionDesc:
            "Selecione um departamento para que os contatos sem departamento sejam redirecionados",
          default: "Padrão",
          group: "Permitir grupos",
          timeSendQueue: "Tempo em minutos para redirecionar para o departamento",
          importAlert:
          ...
          timeToReturnQueue: "Tempo para retornar ao departamento em minutos",
          ...
          queueIdImportMessages: "Departamento para importar as mensagens",
          isOficial: "Oficial",
        ...
        errorSendQueue:
          "Foi informado tempo para redirecionar para o departamento, porém não foi selecionado departamento para redirecionar. Os dois campos precisam estar preenchidos",
        errorExpiresNPS:
      ...
      contactModal: {
        ...
        walletError: "Usuário não possui departamentos associados",
      ...
      wallets: {
        ...
        selectQueue: "Selecionar departamento",
        selectUserAndQueue: "Selecione um usuário e um departamento",
        cancel: "Cancelar",
        save: "Salvar",
      ...
      queueModal: {
        title: {
          queueData: "Dados do departamento",
        ...
        form: {
          ...
          queue: "Departamento para transferência",
      ...
      userModal: {
        ...
        form: {
          ...
          allTicket: "Visualizar chamados sem departamento",
          ...
          allHistoric: "Ver conversas de outros departamentos",
      ...
      tagModal: {
        ...
        form: {
          ...
          nextLaneId: "Lane",
          laneKanbanPositionTitle: "Posição da coluna no Kanban",
          laneKanbanAnchor: "Referência da coluna",
          laneKanbanPlacement: "Posição em relação à referência",
          laneKanbanPlacementBefore: "Antes desta coluna",
          laneKanbanPlacementAfter: "Depois desta coluna",
          laneKanbanPlacementHelp:
            "Define onde esta lane aparecerá em relação a outra coluna (exceto você mesmo).",
        ...
        laneOrderApplyError:
          "Lane salva, mas a posição da coluna no Kanban não pôde ser atualizada.",
      },
      fileModal: {
        title: {
      ...
      tickets: {
        ...
        buttons: {
          showAll: "Todos",
          returnQueue: "Devolver ao departamento",
      ...
      transferTicketModal: {
        ...
        fieldQueueLabel: "Transferir para o departamento",
      ...
      queueSelect: {
        ...
        inputLabelRO: "Departamentos somente leitura",
        withoutQueue: "Sem departamento",
      },
      reports: {
        title: "Relatórios de Atendimentos",
        startDate: "Data Inicial",
      ...
      compaies: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Todos os dados da empresa serão perdidos. Os tickets abertos deste usuário serão movidos para o departamento.",
        },
      },
      plans: {
        form: {
      ...
      settings: {
        ...
        settings: {
          ...
          options: {
            ...
            queueManagement: "Gerenciamento por Departamento",
            ...
            sendMsgTransfTicket:
              "Enviar mensagem transferência de departamento/atendente",
            ...
            sendQueuePosition: "Enviar mensagem com a posição no departamento",
          ...
          customMessages: {
            sendQueuePositionMessage: "Mensagem de posição no departamento",
            ...
            transferMessage:
              "Mensagem de transferência - ${queue.name} = departamento destino",
          },
          LGPD: {
            title: "LGPD",
      ...
      messagesAPIInstructions: {
        ...
        fieldQueueId: '"queueId": ID do departamento ou ""',
      ...
      whitelabel: {
        ...
        listItemBgColor: "Cor de Fundo do Menu Ativo",
