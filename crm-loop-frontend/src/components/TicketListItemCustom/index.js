...
const TicketListItemCustom = ({ setTabOpen, ticket }) => {
  ...
  const handleCloseTicket = async (id, e) => {
    if (e) {
      e.stopPropagation(); // Impede que o clique abra o ticket
    }
  ...
  const handleCloseIgnoreTicket = async (id, e) => {
    if (e) {
      e.stopPropagation(); // Impede que o clique abra o ticket
    }
                ...
                {(ticket.status === "pending" || ticket.status === "lgpd") &&
                  (user.userClosePendingTicket === "enabled" ||
                    ...
                    <ButtonWithSpinner
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleCloseIgnoreTicket(ticket.id, e);
                      }}
                    >
