...
const TicketActionButtonsCustom = ({
  ...
  const handleLinkToWallet = async () => {
    ...
    try {
      ...
      // Usa o primeiro departamento do usuário
    ...
    <>
      ...
      <div className={classes.actionButtons}>
        ...
        {(ticket.status === "open" || ticket.status === "group") && (
          <>
            ...
            <>
              ...
              {/* Ícone para devolver ticket ao departamento */}
              <IconButton
                size="small"
                className={classes.bottomButtonVisibilityIcon}
        ...
        <IconButton
          ...
          style={{ padding: 4 }}
        >
          <MoreVert style={{ fontSize: "1.2rem", padding: 0 }} />
        </IconButton>
        <Menu
          id="menu-appbar"
          anchorEl={anchorEl}
